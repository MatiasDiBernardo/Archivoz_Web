$(document).ready(function(){
    ...
    tl.fromTo(title, {y : 1000, opacity: -2000}, {y: 0, opacity : 100, ease: "back.out(0.5)",duration: 1.1})
      .fromTo(sub, {y : 1000, opacity: -2000}, {y: 0, opacity : 100, ease: "back.out(0.5)",duration: 1.1}, ">-0.9")
      .fromTo(comenzar, {y : 1000, opacity: -2000}, {y: 0, opacity : 100, ease: "back.out(0.5)",duration: 1.1}, ">-0.9")
