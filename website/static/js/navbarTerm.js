...
const contenedorDeTerminos = document.getElementsByClassName('terms-container')[0];
...
function handleMenuChange(e) {
    ...
    if(e.matches && navegacion.classList.contains("nav-conteiner__navegacion-visible")) {
        ...
        if(contenedorDeTerminos) contenedorDeTerminos.inert = true;
    ...
    // Si el menu de la navbar está cerrado en vista "movil", bloquea los enlaces del navbar, habilita el resto
        ...
        if(contenedorDeTerminos) contenedorDeTerminos.inert = false;
